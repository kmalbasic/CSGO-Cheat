...
public:
	...
	void draw_polygon(int n,  bool clip_vertices = true) {
		using original_fn = void(__thiscall*)(i_surface*, int,  bool);
		return (*(original_fn * *)this)[106](this, n,  clip_vertices);
	}
	...
	void draw_textured_polygon(int vertex_count,  bool clip_vertices = true) {
		using original_fn = void(__thiscall*)(i_surface*, int,  bool);
		return (*(original_fn * *)this)[106](this, vertex_count,  clip_vertices);
	}
